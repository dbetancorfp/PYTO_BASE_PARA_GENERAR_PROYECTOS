// elementId: login-button (Postgres-backed UserRepository, unit-tested via a Bun.SQL double
// — added after review-report.md's FAIL, see MEMORY note "coverage-gate-dip-tension")
